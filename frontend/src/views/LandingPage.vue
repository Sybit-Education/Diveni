    ...
    <b-container class="my-5">
      <b-card-group deck class="justify-content-center">
        ...
        <landing-page-card
          ...
          :button-text="
            $t('page.landing.meeting.reconnect.buttons.start.label')
          "
    ...
    <b-container class="py-5">
      ...
      <b-card-group deck>
        <b-card title="Set up Session">
          ...
          <b-card-text>
            You could import your user stories or connect JIRA to syncronize
            story points.
          </b-card-text>

          <b-card-sub-title> Connecting Atlassian Jira </b-card-sub-title>
          <b-card-text>
            DIVENI could connect to JIRA Server and Cloud to show user stories
            and update the voted results of your planning poker.
          </b-card-text>
        </b-card>
        <b-card title="Invite your Team">
          <b-card-text>
            Invite your team using QR-Code, invite link or code.
          </b-card-text>
          <b-card-text>
            Every user will be randomly assinged to a animal and is ready to
            estimate.
          </b-card-text>
          <b-card-text>
            If everybody is in the session, you could start estimation. Having
            defined a time limit this will be used as limit for voting time.
          </b-card-text>
        </b-card>

        <b-card title="Estimate User Stories">
          <b-card-text>
            Every member of team could use your defined set to vote the selected
            user story.
          </b-card-text>
          <b-card-text>
            If erverybody has voted, DIVENI shows results and randomly selects
            two voters having voted minimum / maximum to discuss their
            estimation.
          </b-card-text>
          <b-card-text>
            After discussion you could repeat estimation.
          </b-card-text>
        </b-card>
      </b-card-group>
      <h1 class="mt-5">About DIVENI</h1>
      <p>
        DIVENI was initially developed by students of HTWG Constance and is open
        source now.
      </p>
      <p>
