...
public class WebSocketServiceTest {
    ...
    public void sendMembersUpdate_sendsUpdate() throws Exception {
        ...
        val session = new Session(new ObjectId(), defaultAdminPrincipal.getSessionID(),
                ...
                List.of(new Member(defaultMemberPrincipal.getMemberID(), null, null, null, null, null, true)),
    ...
    public void sendSessionStates_sendsToAll() throws Exception {
        ...
        val session = new Session(new ObjectId(), defaultAdminPrincipal.getSessionID(),
                ...
                List.of(new Member(defaultMemberPrincipal.getMemberID(), null, null, null, null, null,
                        true), new Member(memberPrincipal.getMemberID(), null, null, null, null, null, true)),
                new HashMap<>(), new ArrayList<>(), SessionState.WAITING_FOR_MEMBERS, null, null, null);
    ...
    public void adminLeft_sendsNotification() throws Exception {
        ...
        val session = new Session(new ObjectId(), defaultAdminPrincipal.getSessionID(),
                ...
                new SessionConfig(List.of(), List.of(), null, "US_MANUALLY", "password"), null,
                List.of(new Member(defaultMemberPrincipal.getMemberID(), null, null, null, null, null, true),
                        new Member(memberPrincipal.getMemberID(), null, null, null, null, null, true)),
                new HashMap<>(), new ArrayList<>(), SessionState.WAITING_FOR_MEMBERS, null, null, null);
