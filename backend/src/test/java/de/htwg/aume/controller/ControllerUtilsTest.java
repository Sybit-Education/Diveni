...
public class ControllerUtilsTest {
    ...
    public void getExistingSession_isCorrect() {
        ...
        assertEquals(session, ControllerUtils.getSessionOrThrowResponse(databaseServiceMock, UUID.randomUUID()));
    }
    ...
    public void getEmptySession_isError() {
        ...
        assertThrows(ResponseStatusException.class, () -> ControllerUtils.getSessionOrThrowResponse(databaseServiceMock, UUID.randomUUID()));
    }
    ...
    public void getExistingMemberSession_isCorrect() {
        ...
        assertEquals(session, ControllerUtils.getSessionByMemberIDOrThrowResponse(databaseServiceMock, UUID.randomUUID()));
    }
    ...
    public void getEmptyMemberSession_isError() {
        ...
        assertThrows(ResponseStatusException.class, () -> ControllerUtils.getSessionByMemberIDOrThrowResponse(databaseServiceMock, UUID.randomUUID()));
    }
}
