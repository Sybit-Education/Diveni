...
public class WebsocketControllerTest {
    ...
    public void registerAdminPrincipal_isRegistered() throws Exception {
        ...
        sessionRepo.save(new Session(sessionID, adminID, UUID.randomUUID(), new SessionConfig(new ArrayList<>(), null),
    ...
    public void registerMemberPrincipal_isRegistered() throws Exception {
        ...
        assertEquals(1, webSocketService.getMemberMap().get(adminPrincipal).size());
        assertTrue(webSocketService.getMemberMap().get(adminPrincipal).contains(memberPrincipal));
    }
    ...
    public void unregisterMemberPrincipal_isUnregistered() throws Exception {
        ...
        assertEquals(1, webSocketService.getMemberMap().size());
        assertTrue(webSocketService.getMemberMap().get(adminPrincipal).isEmpty());
    }
