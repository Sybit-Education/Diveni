...
public class WebSocketServiceTest {
    ...
    public void getSessionPrincipals_isCorrect() throws Exception {
        ...
        Assertions.assertEquals(new SessionPrincipals(defaultAdminPrincipal.getSessionID(), defaultAdminPrincipal,
    ...
    public void addMember_isAdded() throws Exception {
        ...
        Assertions.assertTrue(webSocketService.getSessionPrincipals(defaultAdminPrincipal.getSessionID())
    ...
    public void addExistingMember_notDuplicate() throws Exception {
        ...
        Assertions.assertEquals(1, webSocketService.getSessionPrincipals(defaultAdminPrincipal.getSessionID())
