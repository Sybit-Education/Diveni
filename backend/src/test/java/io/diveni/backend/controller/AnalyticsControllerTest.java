...
public class AnalyticsControllerTest {
    ...
    public void getDiveniData_oneSessionWith0AttendeesAndOneDeletedSessionWith2Attendees()
        ...
        sessionRepo.save(
                new Session(
                        ...
                        null,
                        LocalDate.of(2000, 12, 12)));
        Session willBeDelted = new Session(
                new ObjectId(),
                Utils.generateRandomID(),
                Utils.generateRandomID(),
                new SessionConfig(new ArrayList<>(), List.of(), 10, "US_MANUALLY", null),
    ...
    @Test
    public void getCurrentDiveniData_oneSessionWith2AttendeesAndOneDeletedSessionGetOnlyTheStillRunningSession()
            throws Exception {
        sessionRepo.deleteAll();
        sessionRepo.save(
                new Session(
    ...
    @Test
    public void getDiveniDataFromLastMonth_oneSessionWith3AttendeesAndOneSessionWith2AttendesButNotLastMonth()
            throws Exception {
        sessionRepo.deleteAll();
        sessionRepo.save(
                new Session(
    ...
    @Test
    public void getDiveniDataFromLastMonth_oneSessionWith3AttendeesAndOneSessionWith2AttendesAndDeletedAndFromLastMonth()
            throws Exception {
        sessionRepo.deleteAll();
        sessionRepo.save(
                new Session(
    ...
    @Test
    public void getDiveniDataFromLastMonth_oneSessionWith3AttendeesAndOneSessionWith2AttendesAndDeletedAndNotFromLastMonth()
            throws Exception {
        sessionRepo.deleteAll();
