...
public class ProjectManagementController {
  ...
  JiraCloudService jiraCloudService;
	...
	public ResponseEntity<JiraRequestToken> getRequestToken() {
	  ...
	  ResponseEntity<JiraRequestToken> response = new ResponseEntity<>(
	    jiraServerService.getRequestToken(), HttpStatus.OK);
		LOGGER.debug("<-- getRequestToken()");
    return response;
	}
    ...
    ResponseEntity<List<Project>> response;
      ...
      response = new ResponseEntity<>(projectManagementProvider.getProjects(tokenIdentifier), HttpStatus.OK);
    }
    ...
    ResponseEntity<List<UserStory>> response;
      ...
      LOGGER.warn("Bad Request: projectManagementProvider is null!");
		  ...
		  response = new ResponseEntity<>(projectManagementProvider.getIssues(tokenIdentifier, projectName), HttpStatus.OK);
    }
    ...
    ResponseEntity<String> response = new ResponseEntity<>(projectManagementProvider.createIssue(
      tokenIdentifier, projectID, userStory), HttpStatus.OK);
