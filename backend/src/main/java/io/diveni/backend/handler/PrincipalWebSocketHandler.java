...
/**
 * Set anonymous user (Principal) in WebSocket messages by using uri query UUIDs. This is necessary
 * to avoid broadcasting messages but sending them to specific user sessions
 */
