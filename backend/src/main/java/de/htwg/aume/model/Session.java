...
public class Session {
	...
	public Session updateEstimation(UUID memberID, String vote) {
		...
		return new Session(sessionID, adminID, sessionConfig, updatedMembers, sessionState);
	}
	...
	public Session updateSessionState(SessionState updatedSessionState) {
		return new Session(sessionID, adminID, sessionConfig, members, updatedSessionState);
	}
